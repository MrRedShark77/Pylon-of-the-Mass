...
function doCreateGridElements() {
    ...
    createGridElement("the-end",{
        ...
        <p>SUCK EVERYTHING INTO THE BLACK HOLE FOREVER! TRANSFERRING EVERY POTENTIAL ENERGY INTO <span id="hidden-text-te">????</span> PRODUCTION!</p><p>This is the end, but at what cost?</p>
        </button>
        `,
